<?php
    ...
    #styles
    // $_styles = ""
    //     ."<link rel=\"stylesheet\" type=\"text/css\" href=\"/css/generic.css\" media=\"screen\">\n";
    
    #scripts
    // $_scripts = ""
    //     ."<script type=\"text/javascript\" src=\"/js/generic.min.js\"></script>\n";
...
/*    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    ?>
    <p><?=$_SERVER['REQUEST_METHOD']?>...You are session <?php echo $_SESSION['token']; ?>, instance <?=$instance?></p>
    <p><?=$_POST["email"]?></p>
    <?*/
    ...
    if ($_POST["worthless"] != "") {
        ...
        if(!$validEmail) {
            ...
            //$returnpath = "-f" . $mailRecipient;
            //mail("cesar@cssgangsters.com", $subject, $emailBody, $header);
            //mail("mainwolfito@gmail.com", $subject, $emailBody, $header);
            //mail("mainwolfito@yahoo.com", $subject, $emailBody, $header);
            //mail("wolmar@cssgangsters.com", $subject, $emailBody, $header);
            //mail("angela@cssgangsters.com", $subject, $emailBody, $header);
